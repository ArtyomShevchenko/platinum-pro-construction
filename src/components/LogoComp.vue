<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="71" height="60" viewBox="0 0 71 60" fill="none">
        <path d="M11.5833 45.8454V25.5728H12.8336V44.595H32.308V45.8454H11.5833Z" stroke-width="0.00786369" />
        ...
        <path d="M33.46 45.5976H58.8597" stroke-width="0.495413" />
        <path d="M33.46 41.2726H55.785" stroke-width="0.495413" />
        <path fill-rule="evenodd" clip-rule="evenodd"
            d="M34.0498 10.5525L61.9266 24.9043L62.1534 24.4639L34.0498 9.9953V10.5525Z" />
        <path fill-rule="evenodd" clip-rule="evenodd"
            d="M34.0498 13.7452L61.9266 28.097L62.1534 27.6565L34.0498 13.188V13.7452Z" />
    </svg>
</template>
